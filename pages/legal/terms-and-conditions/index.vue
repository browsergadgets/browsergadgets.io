  ...
  <div class="terms-container">
    ...
    <div class="partOfDoc-wrapper">
      ...
      <ul>
        ...
        <li>Free versions store all data locally on the user's device.</li>
    ...
    <div class="partOfDoc-wrapper">
      ...
      <ul>
        <li>All logos, graphics, character designs, and other visual assets used in BrowserGadgets.io and its products
          are the
          exclusive property of Prakhar Tiwari.</li>
        <li>Our code, including software, scripts, and other proprietary technologies, is protected by copyright laws.
        </li>
        <li>Unauthorized reproduction, distribution, or modification of any assets, code, or content without explicit
          written
